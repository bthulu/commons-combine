...
public class ThreadPoolUtil {
	 ...
	 */
	public static ThreadFactory buildThreadFactory(@Nonnull String threadNamePrefix) {
	...
	private static class SafeRunnable implements Runnable {
		...
		public void run() {
			try {
				...
				// catch any exception, because the scheduled thread will break if the
				// exception thrown to outside.
