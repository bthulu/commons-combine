...
/**
 * 关于Set的工具集合.
 * guava中的{@link Sets}, 包含了并集#union, 交集#intersection, 差集#differenceView, 补集(反交集)#disjointView
 *
...
public class SetUtil {
	 ...
	 * @return 高性能, 并发安全的Set
	 */
	public static <T> Set<T> newConcurrentHashSet(ConcurrentHashMap<T, Boolean> concurrentHashMap) {
		return Collections.newSetFromMap(concurrentHashMap);
	}

	/**
	 * 集合中是否含有指定的元素.
	 * 这里的元素指2的非负整数次方的数, 如0b0001, 0b0010, 0b0100, 0b1000等.
	 * 集合指元素相加后的数, 如0b0001与0b0100的集合数就是0b0101.
