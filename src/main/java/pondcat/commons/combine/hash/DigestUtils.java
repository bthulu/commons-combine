...
public abstract class DigestUtils {
	 ...
	 * @return the digest
	 */
	public static byte[] digest(final MessageDigest messageDigest,
	 ...
	 * >Appendix A in the Java Cryptography Architecture Reference Guide</a> for
	...
	/**
	 * Returns a <code>MessageDigest</code> for the given <code>algorithm</code> or a
	 ...
	 */
	public static MessageDigest getDigest(final String algorithm,
			final MessageDigest defaultMessageDigest) {
		try {
			return MessageDigest.getInstance(algorithm);
		}
	 ...
	 * @throws IllegalArgumentException when a {@link NoSuchAlgorithmException} is caught,
	 * which should never happen because MD2 is a built-in algorithm
	 */
	 ...
	 */
	public static MessageDigest updateDigest(final MessageDigest messageDigest,
			final ByteBuffer valueToDigest) {
		messageDigest.update(valueToDigest);
		return messageDigest;
	}
	...
	/**
	 * Updates the given {@link MessageDigest} from a String (converted to bytes using
	 * UTF-8).
	 * <p>
	 * To update the digest using a different charset for the conversion, convert the
	 * String to a byte array using {@link StandardCharsets#UTF_8}
	 * @param messageDigest the {@link MessageDigest} to update
	 * @param valueToDigest the value to update the {@link MessageDigest} with; converted
	 * to bytes using {@link StandardCharsets#UTF_8}}
	 * @return the updated {@link MessageDigest}
	 */
	public static MessageDigest updateDigest(final MessageDigest messageDigest,
