...
import pondcat.commons.combine.Platforms;
...
public class FileUtil {
	...
	public static List<String> toLines(final File file) throws IOException {
		return toLines(file, StandardCharsets.UTF_8);
	}
	 ...
	 * @see Files#readAllLines
	 */
	public static List<String> toLines(final File file, Charset cs) throws IOException {
	...
	public static BufferedReader asBufferedReader(String fileName) throws IOException {
		return asBufferedReader(fileName, StandardCharsets.UTF_8);
	}
	...
	public static BufferedReader asBufferedReader(Path path) throws IOException {
		return asBufferedReader(path, StandardCharsets.UTF_8);
	}
	...
	public static BufferedWriter asBufferedWriter(String fileName) throws IOException {
		return asBufferedWriter(fileName, StandardCharsets.UTF_8);
	}
	...
	public static BufferedWriter asBufferedWriter(Path path) throws IOException {
		return asBufferedWriter(path, StandardCharsets.UTF_8);
	}
	...
	private static Path getPath(String filePath) {
		Validate.notBlank(filePath, "filePath is blank");
