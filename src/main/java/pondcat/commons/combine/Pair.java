 ...
 * 如:[{"left":1,"right":"lily"},{"left":2,"right":"lucy"}], 而不是:{1:"lily",2:"lucy"}.</p>
 * 因commons-lang3的{@link org.apache.commons.lang3.tuple.Pair}继承自Entry, 会导致序列化行为与map类似, 故予以改写.
 * 对需返回三个变量的, 请使用{@link org.apache.commons.lang3.tuple.Triple}.
 */
